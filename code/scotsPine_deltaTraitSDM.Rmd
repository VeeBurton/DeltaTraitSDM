...
Mask using current distribution...

```{r current-dist, include=TRUE,echo=FALSE,fig.cap="Current distribution of native Scots pine"}
...
Future climate = RCP 8.5 2050 from HadGCM model.

```{r DTSDM3, include=TRUE, echo=FALSE}
...
names(rsmax3)
plot(rsmax3,main="Raster stack for model input")
predH4 <- predict(rsmax3, dredge3, re.form=NA, type='response') #whittet.mod2 #dredge1
predH4<- exp(predH4)
