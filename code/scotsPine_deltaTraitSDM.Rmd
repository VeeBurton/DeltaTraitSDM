...
dmod3.int <- lmer(log(Hraw) ~ DD0_P + PAS_T + DD0_P*PAS_T + (1|Trial/Block/Provenance), data=sp)
init.compare <- compare_performance(pair.mod1,pair.mod2,pair.mod3,pca.mod1,pca.mod2,pca.mod3,diff.mod1,diff.mod2,diff.mod3,dmod3.int, rank = TRUE)
knitr::kable(head(init.compare[,1:9],10), booktabs=TRUE,
