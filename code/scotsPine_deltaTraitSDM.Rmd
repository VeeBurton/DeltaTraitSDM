...
This showed that there are statistically significant differences between provenances within trials (effect size 0.25, p<0.0001), illustrating thate there is both intra-specific genetic variability and phenotypic plasticity in the sample.
...
The results of the cross validation (Figure \@ref(fig:cross-validation)) indicate that "dredge2" and "dredge3" have the highest average R2 marginal. Both also showed the lowest average MAE.
