...
ggboxplot(
  ...
  color = "Provenance", palette = "viridis")
...
#write.csv(results, paste0(wd,'Scots_pine/cross-validation_results_interactions3.csv'))

```


```{r cv-results, include=T, echo=FALSE, warning=FALSE}
results<-read.csv(paste0(wd,'Scots_pine/cross-validation_results_interactions3.csv')) # PC
