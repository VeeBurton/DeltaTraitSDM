...
A number of models combining the potentially 'important' variables highlighted above have been produced (see code chunk below).
...
Figure \@ref(fig:DTSDM1) shows predicted height distribution 
