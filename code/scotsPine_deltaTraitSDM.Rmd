...
knitr::include_graphics(paste0(wd,'figures/scotsPine_height_trial-prov.png'))
...
#climate <- read.csv(paste0(wd,"climate_surfaces/for-climateEU_Normal_1961_1990Y.csv"))
#climate <- read.csv(paste0(wd,"data-raw/for-climateEU_Normal_1961_1990Y.csv")) # mac
#head(climate)
#colnames(climate)<-c('x','y','lat','long','elev','MAT','MWMT','MCMT','TD','MAP','MSP','AHM','SHM','DD0','DD5','DD_18','DD18','NFFD','bFFP','eFFP','FFP','PAS','EMT','Eref','CMD')
#climate[climate=="-9999"]<-NA
#climate <- na.omit(climate)
...
Predicted height appears to increase overall (although be aware of scaled data and exponential) and distribution extends - drier, warmer, eastern areas of the UK?
...
Is this valid? Unsure we can trust the results...
